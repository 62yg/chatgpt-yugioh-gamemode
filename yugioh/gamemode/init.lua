...
if duelData == nil or duelData.LifePoints == nil then
    SetDuelData(ply, { LifePoints = 8000, Deck = {}, Hand = {}, Field = {}, Graveyard = {} })
end
...
function SetDuelData(ply, duelData)
    ply:SetNW2Int("LifePoints", duelData.LifePoints)
    ply:SetNW2String("Deck", util.TableToJSON(duelData.Deck))
    ply:SetNW2String("Hand", util.TableToJSON(duelData.Hand))
    ply:SetNW2String("Field", util.TableToJSON(duelData.Field))
    ply:SetNW2String("Graveyard", util.TableToJSON(duelData.Graveyard))
end


function GetDuelData(ply)
    return {
        LifePoints = ply:GetNW2Int("LifePoints"),
        Deck = util.JSONToTable(ply:GetNW2String("Deck")),
        Hand = util.JSONToTable(ply:GetNW2String("Hand")),
        Field = util.JSONToTable(ply:GetNW2String("Field")),
        Graveyard = util.JSONToTable(ply:GetNW2String("Graveyard")),
    }
end
